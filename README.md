...
Gutter position - Display the heading level gutter before or after the line numbers (if you use the extra markdown editor settings plugin to display line numbers).
